...
function waDefaultMsg(o) {
  ...
  return `שלום ${o.name}, בהמשך להזמנתך באתר למדים טקטיים, טרם הושלם התשלום עבור הזמנה #${o.orderNumber || ''} על סך ₪${o.total || 0} עבור ${products}.\nלהשלמת ההזמנה אנא העבר הסכום דרך PAYBOX, BIT, או העברה בנקאית.`;
}
